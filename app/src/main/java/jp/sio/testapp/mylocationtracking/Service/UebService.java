package jp.sio.testapp.mylocationtracking.Service;
...
public class UebService extends Service implements LocationListener {
    ...
    public void locationStart() {
        ...
        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, settingInterval, 0, this);
    ...
    public void locationSuccess(final Location location) {
        ...
        */
        ...
        /* intervalはlocationUpdatesに入れたから不要
        else {
